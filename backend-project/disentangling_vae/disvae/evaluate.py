...
from disentangling_vae.disvae.models.losses import get_loss_f
from disentangling_vae.disvae.utils.math import log_density_gaussian
...
class Evaluator:
    ...
    def __call__(self, data_loader, is_metrics=False, is_losses=True):
        ...
        """
        from disentangling_vae.disvae.utils.modelIO import save_metadata
        start = default_timer()
