    ...
    <div className="uploaderScreenContainer">
      ...
      <div className="textContainer">
        ...
        <ol>
          ...
          <li>Use the weights in the Filter menu to give more or less importance to a dimension while computing the distance between two images. By default all 
          ...
          <li>Look at the Projection menu to have an overview of the full dataset in 2D. The similar images and your uploaded image will be highlighted
            so that you can easily find them. You can have more information about one image by putting your mouse over it in the visualization.</li>
        </ol>
        ...
        However, by forcing our network to use a small latent space, we force it to keep only the useful information to represent the images of our dataset. This is
        why we can then use it to compute the distance between different images. Furthermore, by adding some little changes to our network, we are able to force it to
        ...
        others. This is why this dashboard provides the option to rename some dimensions which might be representative and weight the different dimensions accordingly before
